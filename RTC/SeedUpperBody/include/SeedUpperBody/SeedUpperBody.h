...
#ifndef SEEDUPPERBODY_H
#define SEEDUPPERBODY_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  SeedUpperBody(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  DualManipulatorCommonInterface_CommonCommandsSVC_impl m_DualManipulatorCommonInterface_CommonCommands;
  /*!
   */
  DualManipulatorCommonInterface_MotionCommandsSVC_impl m_DualManipulatorCommonInterface_MotionCommands;
  /*!
   */
...
extern "C"
{
  DLL_EXPORT void SeedUpperBodyInit(RTC::Manager* manager);
};

#endif // SEEDUPPERBODY_H
