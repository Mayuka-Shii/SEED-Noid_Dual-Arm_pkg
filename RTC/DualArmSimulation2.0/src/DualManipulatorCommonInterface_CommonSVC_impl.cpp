...
JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoOFFArm()
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoOFFArm()>"
#endif
  return result;
}
...
JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoOFFHand()
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoOFFHand()>"
#endif
  return result;
}
...
JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoONArm()
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoONArm()>"
#endif
  return result;
}
...
JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoONHand()
{
  ...
  // Please insert your code here and remove the following warning pragma
#ifndef WIN32
  #warning "Code missing in function <JARA_ARM_DUAL::RETURN_ID* JARA_ARM_DUAL_DualManipulatorCommonInterface_CommonSVC_impl::servoONHand()>"
#endif
  return result;
}
